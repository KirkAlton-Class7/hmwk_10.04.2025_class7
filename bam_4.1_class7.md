...
7. Add User Data script for each corresponding instance
	- Instance 1: [Private Client 1 Script](./private_client_1_script.sh)
	- Instance 2: [Private Client 2 Script](./private_client_2_script.sh)
	- Instance 3: [Private Client 3 Script](./private_client_3_script.sh)
8. Launch instance
...
1. Download an RDP client for your OS.
	<br> https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/connect-rdp.html
...
6. Type `exit` and press enter to sign out.
...
- Amazon EC2 key pairs and Amazon EC2 instances
	<br> https://docs.aws.amazon.com/AWSEC2//UserGuide/ec2-key-pairs.html
